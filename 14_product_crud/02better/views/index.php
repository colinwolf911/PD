<?php
// getting https://getbootstrap.com/for user TO GET CSS TEMPLATE
//getting https://jsonplaceholder.typicode.com/for fake data
//to make connection with db
///SQLI OR PDO ,PDO IS MORE POWERFUL BECAUSE IT'S OBJECTIVE BASE
...
//making change of schema by using exec
//pdf statment
$statement= $pdo->prepare('SELECT*FROM products ORDER BY create_date DESC');
$statement->execute();
...
//var_dump($products);
//echo '</pre>';
//now need it to be iteration with those columns from db 
//moving to the table in html
?>
